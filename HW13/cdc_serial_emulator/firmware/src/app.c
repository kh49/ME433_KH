...
//                         
//                          
//                    if (direction> 160){ //right 
//                        sensitivity = min((direction-160)^(2/3),10);//qq % 1000;
//                        //speed = speed-(direction-160)*6;
////                        if (direction > 230){
////                            speed = 2500;
////                        }
////                        
//                        OC1RS = speed;
//                        OC2RS = max(speed-(direction-160)*sensitivity,300);
//            }
//                    else if (direction< 160) {
//                        sensitivity = min((160-direction)^(2/3),10);//qq % 1000;
//                        //speed = speed - (160-direction)*6;
////                        if (direction < 90){
////                            speed = 2500;
////                        }
//                        OC2RS = speed;
//                        OC1RS = max(speed-(160-direction)*sensitivity,300);
//            }
//                    else {
//                        
//                        OC1RS = speed;
